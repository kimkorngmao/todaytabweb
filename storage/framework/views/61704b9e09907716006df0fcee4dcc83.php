...
<main>
            ...
            <?php $__currentLoopData = $featuredArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($loop->first): ?>
                    <article class="group block relative w-full h-full md:aspect-video overflow-hidden">
                        <a href="<?php echo e(route('articles.show', ['slug' => $article->slug])); ?>" class="block h-full">
                            <figure>
                            ...
                            <div class="absolute bottom-0 left-0 p-6 text-white">
                                ...
                                <div class="inline-block bg-white px-3 mb-2 shadow-[4px_4px_0px_rgba(255,188,59,1)]">
                                    <span class="text-black font-semibold text-sm"><?php echo e($article->category?->name); ?></span>
                                </div>
                ...
                <?php else: ?>
                    ...
                    <article class="group flex gap-5">
                        <a href="<?php echo e(route('articles.show', ['slug' => $article->slug])); ?>" class="flex gap-5 w-full">
                            <figure class="aspect-video w-1/4 bg-gray-200 overflow-hidden">
                                <img src="<?php echo e($article->featured_image_url ?? '/images/thumb-placeholder.jpg'); ?>"
                                    alt="Thumbnail for <?php echo e($article->title); ?>" class="w-full h-full object-cover" loading="lazy" />
                            </figure>
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600 line-clamp-2">
                                    <?php echo e($article->excerpt ?? Str::limit($article->content, 120)); ?>

                                </p>
                                <time datetime="<?php echo e($article->published_at); ?>"
                                    class="text-xs text-gray-400 mt-1 inline-block"><?php echo e(\Carbon\Carbon::parse($article->published_at)->diffForHumans()); ?></time>
                            </div>
                        </a>
                    </article>
                ...
                <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="group block">
                        <a href="<?php echo e(route('articles.show', ['slug' => $article->slug])); ?>">
                            ...
                            <h3 class="group-hover:underline font-semibold mt-2 line-clamp-2 text-md"><?php echo e($article->title); ?></h3>
        ...
        <section aria-labelledby="popular-articles-heading">
            ...
            <div>
                <?php $__currentLoopData = $popularArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <article class="flex group gap-5 border-t border-gray-200 py-2 <?php echo e($loop->last ? 'border-b' : ''); ?>">
                        <a href="<?php echo e(route('articles.show', ['slug' => $article->slug])); ?>" class="flex gap-5 w-full">
                            <div class="flex-shrink-0">
                                <span class="text-3xl font-black transition-colors <?php echo e($loop->index < 1 ? 'text-red-500' : ($loop->index < 2 ? "text-green-500" : ($loop->index < 3 ? "text-yellow-500" : 'text-gray-300'))); ?> group-hover:text-black">
    ...
    <section>
        <?php $__currentLoopData = $featuredCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <section aria-labelledby="category-<?php echo e($category->id); ?>-heading">
                <div class="pt-2 mb-6">
                    <div class="flex gap-2 mb-2">
                        ...
                        <h2 id="category-<?php echo e($category->id); ?>-heading" class="text-lg font-bold uppercase tracking-wider text-black"><?php echo e($category->name); ?></h2>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        ...
                        <div class="lg:col-span-4 space-y-4">
                            <?php if($articles->count() > 1): ?>
                                <?php $__currentLoopData = $articles->skip(1)->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <article class="border-b border-gray-300 pb-4 <?php echo e($loop->last ? 'border-b-0' : ''); ?>">
                                        <a href="<?php echo e(route('articles.show', ['slug' => $article->slug])); ?>" class="block group">
                                            <time datetime="<?php echo e($article->published_at); ?>"
                        ...
                        <div class="lg:col-span-5 border-l border-r border-gray-300 px-6">
                            <article class="h-full">
                                <a href="<?php echo e(route('articles.show', ['slug' => $articles[0]->slug])); ?>"
                                    class="block group h-full">
                                    <figure class="mb-4">
                                        <img src="<?php echo e($articles[0]->featured_image_url); ?>"
                                            alt="<?php echo e($articles[0]->title); ?>"
                                            class="w-full h-64 object-cover border border-gray-300" loading="lazy">
                                    </figure>

                                    <time datetime="<?php echo e($articles[0]->published_at); ?>"
                                        class="text-xs text-gray-400 mb-3 font-bold">
                                        <?php echo e(\Carbon\Carbon::parse($articles[0]->published_at)->diffForHumans()); ?>
                                    ...
                                    <p class="text-sm text-gray-800 leading-relaxed line-clamp-3">
                                        <?php echo strip_tags($articles[0]->content); ?>
                        ...
                        <div class="lg:col-span-3 space-y-4">
                            <div class="grid grid-cols-2 lg:grid-cols-1 gap-5 lg:gap-0">
                                <?php if($articles->count() > 4): ?>
                                <?php $__currentLoopData = $articles->skip(4)->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <article class="border-b border-gray-300 pb-4 <?php echo e($loop->last ? 'border-b-0' : ''); ?>">
                                        <a href="<?php echo e(route('articles.show', ['slug' => $article->slug])); ?>"
                                            class="block group">
                                            <?php if($loop->first): ?>
                                                <figure>
                                                    <img src="<?php echo e($article->featured_image_url); ?>" alt="<?php echo e($article->title); ?>" class="w-full w-full aspect-video object-cover mb-2" loading="lazy">
                                                </figure>
                                            <?php else: ?>
                                                <figure class="lg:hidden">
                                                    <img src="<?php echo e($article->featured_image_url); ?>" alt="<?php echo e($article->title); ?>" class="w-full aspect-video object-cover mb-2" loading="lazy">
                                                </figure>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /homepages/46/d4299097096/htdocs/todaytab/resources/views/pages/index.blade.php ENDPATH**/ ?>