    ...
    <aside id="sidebar" class="hidden md:block w-64 flex-shrink-0 h-screen bg-white fixed md:sticky top-0 left-0 flex flex-col justify-between border-r border-gray-100 z-40">
        <div class="text-gray-900 w-full">
            ...
            <ul class="mt-5 p-4 flex flex-col gap-2">
                ...
                <?php if(auth()->user()->hasPermission('admin.logins.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.logins.index')); ?>"
                            class="flex items-center gap-2 px-4 py-3 rounded-md hover:bg-gray-50 duration-200 <?php echo e(request()->routeIs('admin.logins.*') ? 'bg-blue-50 font-medium' : ''); ?>">
                ...
                <?php if(auth()->user()->hasPermission('admin.visitors.index')): ?>
                    <li>
                        <a href="<?php echo e(route('admin.visitors.index')); ?>"
                            class="flex items-center gap-2 px-4 py-3 rounded-md hover:bg-gray-50 duration-200 <?php echo e(request()->routeIs('admin.visitors.*') ? 'bg-blue-50 font-medium' : ''); ?>">
...
<?php /**PATH D:\todaytabweb\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>