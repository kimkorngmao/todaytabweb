...
<div class="px-6 py-4">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('admin.articles.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150">
            + Create New Article
        </a>
    </div>
                    ...
                    <tr class="hover:bg-gray-50">
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <img class="h-10 w-10 rounded-md object-cover" 
                                        src="<?php echo e($article->featured_image_url ?? asset('images/1x1-placeholder.jpg')); ?>" 
                                        alt="<?php echo e($article->title); ?>">
                                </div>
                                <div class="ml-4 max-w-xs line-clamp-1">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($article->title); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e($article->category->name ?? 'Uncategorized'); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($article->author->username); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                <?php echo e($article->type === 'page' ? 'bg-purple-100 text-purple-800' : ''); ?>

                                <?php echo e($article->type === 'news' ? 'bg-blue-100 text-blue-800' : ''); ?>

                                <?php echo e($article->type === 'blog' ? 'bg-green-100 text-green-800' : ''); ?>">
                                <?php echo e(ucfirst($article->type)); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                ...
                                <?php echo e($article->status === 'draft' ? 'bg-yellow-100 text-yellow-800' : ''); ?>

                                <?php echo e($article->status === 'archived' ? 'bg-gray-100 text-gray-800' : ''); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e(number_format($article->view_count)); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="<?php echo e(route('admin.articles.edit', $article->id)); ?>" class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
                            <form action="<?php echo e(route('admin.articles.destroy', $article->id)); ?>" method="POST" class="inline">
                                <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /homepages/46/d4299097096/htdocs/todaytab/resources/views/admin/articles/index.blade.php ENDPATH**/ ?>