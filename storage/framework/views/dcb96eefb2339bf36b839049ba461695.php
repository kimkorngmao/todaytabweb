...
<div class="max-w-4xl mx-auto px-4 py-8">
    <h2 class="text-2xl font-semibold text-gray-800 mb-6">
            <?php echo e(isset($user) ? 'Edit User' : 'Create User'); ?>
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center space-x-4">
                    <div class="flex-shrink-0 h-20 w-20 rounded-full overflow-hidden bg-gray-200">
                        <?php if(isset($user) && $user->avatar_url): ?>
                            <img src="<?php echo e($user->avatar_url); ?>" alt="User Avatar" class="h-full w-full object-cover">
                        <?php else: ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <textarea id="bio" name="bio" rows="3" 
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('bio', $user->bio ?? '')); ?></textarea>
            </div>
                ...
                <select name="role" id="role" 
                    ...
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($role->id); ?>"
                            <?php echo e((old('role') == $role->id || (isset($user) && $user->roles->first()?->id == $role->id)) ? 'selected' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\todaytabweb\resources\views/admin/users/form.blade.php ENDPATH**/ ?>