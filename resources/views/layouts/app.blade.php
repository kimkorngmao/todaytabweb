...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>
        @yield('title', $siteSettings->where('key', 'site-title')->first()->value ?? 'Today Tab')@hasSection('title')
            - {{ $siteSettings->where('key', 'site-title')->first()->value ?? 'Today Tab' }}
        @endif
    </title>
    ...
    <meta name="keywords" content="@yield('meta_keywords', 'Today Tab, Technologies, news, ai')">
    ...
    <meta property="og:title" content="@yield('title', $siteSettings->where('key', 'site-title')->first()->value ?? 'Today Tab')@hasSection('title') - {{ $siteSettings->where('key', 'site-title')->first()->value ?? 'Today Tab' }}@endif">
    ...
    <meta property="og:image" content="@yield('meta_og_image', asset('images/todaytab-og-image.png'))">
    <meta property="og:site_name" content="@yield('meta_og_site_name', 'Today Tab')">
    <meta property="og:locale" content="{{ str_replace('_', '-', app()->getLocale()) }}">

    <!-- Twitter -->
    <meta name="twitter:card" content="@yield('meta_twitter_card', 'summary_large_image')">
    <meta name="twitter:title" content="@yield('title', $siteSettings->where('key', 'site-title')->first()->value ?? 'Today Tab')@hasSection('title') - {{ $siteSettings->where('key', 'site-title')->first()->value ?? 'Today Tab' }}@endif">
    ...
    <meta name="twitter:image" content="@yield('meta_og_image', asset('images/todaytab-og-image.png'))">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div class="">
                    ...
                    <div class="text-xs text-gray-500">
                        © {{ date('Y') }} Today Tab. All rights reserved.
                    </div>
                </div>
